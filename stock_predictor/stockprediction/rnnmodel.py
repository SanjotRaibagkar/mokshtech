...
class ml_dpmodels(object):
    ...
    def build_predictmodel(self,dataframe,skipdays):
        ...
        regressor.fit(X_train, y_train, epochs = 20, batch_size = 650)
    ...
    def predict_forcast(self,dataframe,skipdays):
        ...
        try:
            ...
            if self.flag==False:
                self.report_dict = fr.create_report(self.report_dict, header, 'Actual',actual_price.values)
        ...
        #     #plt.show()
        #     plt.savefig(repobasepath+str(date.today())+header+'.png')
        # except Exception as e:
        #     print(e)
