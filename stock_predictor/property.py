...
repopath = os.path.join(basepath,'report')


indlist=['NIFTY','NIFTYIT','BANKNIFTY','NIFTYMID50','NIFTYPSE','NIFTYINFRA']  #'FTSE100','INDIAVIX','NIFTYCPSE',  These are not coming
...
reportpath = os.path.join(repopath,reportname)
